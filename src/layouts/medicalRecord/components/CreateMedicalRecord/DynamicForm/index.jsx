    ...
    <>
      <form className="mb-[20px]">
        {fieldList.map((item, index) => {
          return (
            <div key={index} className="w-full flex flex-col gap-[5px] py-[10px]">
              <div className="w-full border-t-4 border-b-4 border-blue-200 p-2 rounded-xl flex flex-col gap-[10px] relative">
